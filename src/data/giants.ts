...
export const GIANTS: GiantDef[] = [
  {
    ...
    seller: {
      ...
      emoji: '🚗',
      lines: [
        '您好。这台车出过一次事故，车架还正，发动机我亲自听过，没问题。',
        '钥匙丢了，行驶证在手套箱里。后备箱有前车主没处理完的东西，我没动，原样给您。',
        '一锤子砸不动它，得上拆卸管线，慢慢肢解。您看好了再签。',
      ],
    },
  },
  {
    ...
    seller: {
      ...
      emoji: '🕴️',
      lines: [
        '客机残骸一架，机身以钛合金为主，发动机叶片完好，适合上管线。',
        '黑匣子还在工作，行李架里的箱子无人认领，按规矩归经手人。',
        '事故原因不在交付范围内。您只买铁，不买真相。现结。',
      ],
    },
  },
  {
    ...
    seller: {
      ...
      emoji: '🕴️',
      lines: [
        '万吨货轮一艘，搁浅状态，船籍证明已经销毁。',
        '甲板上的集装箱我没开过，也建议您慢慢开。',
        '拖不回来，只能就地上重型管线，成吨出货。现场交割。',
      ],
    },
  },
  {
    ...
    seller: {
      ...
      emoji: '🕴️',
      lines: [
        '主战坦克一台，炮闩已焊死，装甲是真材实料。',
        '来源走的是不存在的渠道，所以单据也不存在。',
        '我只确认一件事：它进得来，就出不去。拆吧。',
      ],
    },
  },
];
